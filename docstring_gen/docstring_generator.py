...
# %% auto 0
__all__ = ['DEFAULT_PROMPT_TEMPLATE', 'DOCSTRING_ERR', 'AUTO_GEN_PERFIX', 'AUTO_GEN_BODY', 'AUTO_GEN_SUFFIX', 'AUTO_GEN_TXT',
...
def visit_functions(
    ...
    **kwargs: Any
    ...
    if (
        isinstance(tree, ast.AsyncFunctionDef)
        or isinstance(tree, ast.FunctionDef)
        or isinstance(tree, ast.ClassDef)
    ):
...
def _get_classes_and_functions(source: str) -> List[Tuple[int, int, int, int]]:
    ...
    visit_functions(tree, source=source, callback=callback, retval=retval)
...
def _retry_with_exponential_backoff(
    ...
    def decorator(func):
        ...
        Args:
            ...
            max_wait: The maximum delay between retries
            exponential_base: The exponential base for the delay between retries
            jitter: The jitter for the delay between retries
...
# %% ../nbs/Docstring_Generator.ipynb 18
...
def _fix_docstring_indent(
    ...
    Args:
        ...
        include_auto_gen_txt: If True, include the auto-generated text.
...
def _inject_docstring_to_source(
    ...
    """Inject docstrings to source code.

    Args:
        source: The source code.
        indented_docstrings: The indented docstrings.
        linenos: The line numbers.
...
def _check_and_add_docstrings_to_source(
    ...
    **kwargs: Union[int, float, str, List[str]]
    ...
    Args:
        ...
        recreate_auto_gen_docs: Recreates auto gen docs
...
# %% ../nbs/Docstring_Generator.ipynb 39
def _add_docstring_to_nb(
    ...
    **kwargs: Union[int, float, str, List[str]]
    ...
    Args:
        ...
        include_auto_gen_txt: Whether to include the text "Auto-generated by docstring_gen" in the docstring
        recreate_auto_gen_docs: Whether to recreate the docstrings even if they already exist
        version: The version of the notebook
        **kwargs: Keyword arguments to pass to the docstring_gen function
...
def _add_docstring_to_py(
    ...
    **kwargs: Union[int, float, str, List[str]]
    ...
    Args:
        ...
        include_auto_gen_txt: Whether to include the text 'Auto-generated by docstring_gen' in the docstring.
        recreate_auto_gen_docs: Whether to recreate the docstrings even if they already exist.
        **kwargs: Additional arguments to pass to the docstring_gen function.
